...
class Prem_Prio 
{
  ...
  public static void main(String[] args) 
  {
    ...
    System.out.print("Enter Arrival, Burst time and priority of 1st process: ");
    tp=new ArrayList();
    ...
    a.add(new process(1,t1,t2-1,0,t2-t1,t2,sc.nextInt()));
    ...
    while(true)
    {
      ...
      if(c=='y')
      {
        ...
        tt1=sc.nextFloat();
        tt2=sc.nextFloat();
        a.add(new process(i,tt1,tt2,0,0,tt2,sc.nextInt()));
        Collections.sort(a);
      }
      process pro=a.get(0);
      if(pro.exe==0)
...
class process implements Comparable<process>
{
  ...
  process(int a,float b,float c,float d,float e,float f,int g)
  {
    pid=a;
    arr=b;
    exe=c;
